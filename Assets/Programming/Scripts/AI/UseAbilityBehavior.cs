...
[CreateAssetMenu(fileName = "NewUseAbilityDefinition", menuName = "AI/Behaviour Defintion/Use Ability", order = 0)]
public class UseAbilityBehavior : BehaviourDefinition
{
    [SerializeField]
